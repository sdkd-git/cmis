...
export const GhunhaInfomationTable = (props) => {
    ...
    },
    {
      ...
      render: (text, record) => (
        <Space size="middle">
          ...
          <a onClick={() => gunhaFormDelete(record)}>Delete</a>
        </Space>
      ),
    },
  ];
  ...
  const gunhaFormDelete = (data) => {
    props.deleteGhunhaInfomation(data, _.findIndex(props.data, function(o) { return o.id == data.id; }));
  };
